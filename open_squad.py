...
def share_words(sent1, sent2):
    ...
    share_cnt = 0
    for i in range(len(sent1_words)):
        for j in range(len(sent2_words)):
            if sent1_words[i] in sent2_words[j] or sent2_words[j] in sent1_words[i]:
                share_cnt += 1
...
class SquadResult(object):
    ...
    # def __init__(self, unique_id, start_logits, end_logits, choice_logits, start_top_index=None, end_top_index=None, cls_logits=None):
